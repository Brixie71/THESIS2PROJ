...
def main(onnx_model):
    """
    Main function to load ONNX model, perform inference on camera feed, draw bounding boxes, and display the output image.
    ...
    # Open camera capture
    CCTV_IP_1 = 'rtsp://admin:1Rolando23@192.168.1.108:554/cam/realmonitor?channel=1&subtype=0&unicast=true&proto=Onvif'

    CCTV_IP_2 = 'rtsp://admin:1Rolando23@192.168.1.109:554/cam/realmonitor?channel=1&subtype=0&unicast=true&proto=Onvif'
